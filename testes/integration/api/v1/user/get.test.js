  ...
  describe("Default user", () => {
    ...
    test("With nonexistent session", async () => {
      const nonexistentToken =
        "f59e1f5b0d1864cf224113b08cb23d332447c659e6a2e0c0f46c771a77347e5b7ccbef3c1f495a62d104ad6918cbbf38";
    ...
    test("With expired session", async () => {
      ...
      console.log(sessionObject.expires_at);
      console.log(new Date(jest.now()));
